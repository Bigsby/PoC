...
namespace IntagramClient
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var responseString = client.GetStringAsync("https://api.instagram.com/v1/users/self/media/recent?access_token=3538818996.8930ef2.a116210592954440b297d5e306103026&count=").Result;
            var result = JsonConvert.DeserializeObject<MediaResults>(responseString);
            var stop = "here";
        }
    }
    ...
    {
        public meta meta { get; set; }
        public IEnumerable<Tagm> data { get; set; }
    }
    ...
    {
        IEnumerable<from> data { get; set; }
    }
    public class LikesResponse
    {
        public meta meta { get; set; }
        public IEnumerable<from> data { get; set; }
    }
